...
import { UserOutline, LockOutline, HistoryOutline , ReadOutline, FileOutline, BellOutline, MailOutline} from '@ant-design/icons-angular/icons';
...
const icons: IconDefinition[] = [ UserOutline, LockOutline , HistoryOutline, ReadOutline, FileOutline, BellOutline, MailOutline];
